...
async function testVideoPipeline() {
  ...
  try {
    ...
    console.log('📝 Test 1: Creating new video...')
    ...
    console.log('ℹ️  Note: Embeddings would be generated by OpenAI in production')
    ...
    console.log(`✅ Retrieved ${searchChunks?.length || 0} chunks for RAG:`)
    ...
    console.log('   ✓ Status progression through all stages')
    console.log('   ✓ Transcript storage')
    console.log('   ✓ Chunk generation')
    console.log('   ✓ RAG-ready data structure')
    console.log('   ✓ Data retrieval for AI chat')
