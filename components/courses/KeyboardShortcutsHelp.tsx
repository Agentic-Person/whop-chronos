      ...
      <Card className="relative max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1">
                      {shortcut.keys.map((key, keyIndex) => (
                        <kbd
                          key={keyIndex}
                          className="px-2.5 py-1 text-sm font-semibold text-gray-800 bg-white border border-gray-300 rounded-lg shadow-sm"
                        >
                          {key}
                        </kbd>
                      ))}
        ...
        <div className="p-6 border-t border-gray-200 bg-gray-50">
          <p className="text-sm text-gray-600 text-center">
            Press <kbd className="px-2 py-1 text-xs font-semibold text-gray-800 bg-white border border-gray-300 rounded">?</kbd> anytime to view shortcuts
          </p>
        </div>
      </Card>
    </div>
