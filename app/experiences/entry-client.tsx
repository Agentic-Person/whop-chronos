/**
 * Experiences Entry Client Component
 *
 * This handles the client-side logic:
 * 1. Uses @whop/iframe SDK to get context (experienceId)
 * 2. Redirects to the appropriate experience page
 *
...
interface ExperiencesEntryClientProps {
  hasToken: boolean;
}

export function ExperiencesEntryClient({ hasToken }: ExperiencesEntryClientProps) {
