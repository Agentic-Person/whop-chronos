 ...
 * - Client-side redirects to /dashboard/[companyId]
 * - Dashboard layout reads token from cookie (since redirect doesn't go through Whop proxy)
 */
...
export default async function DashboardEntryPage() {
  ...
  if (whopToken) {
    ...
    console.log('[Dashboard Entry] Token captured from headers and stored in cookie');
  } else {
    console.log('[Dashboard Entry] No token in headers - may be in test mode or direct access');
  }
